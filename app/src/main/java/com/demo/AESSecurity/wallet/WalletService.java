package com.demo.AESSecurity.wallet;

import android.content.Context;
import android.text.TextUtils;


import com.demo.AESSecurity.crypto.ECDSA;
import com.demo.AESSecurity.util.HandlerUtil;
...
public class WalletService {
    ...
    private final String walletSuffixDir = "aes_wallet_service/";
