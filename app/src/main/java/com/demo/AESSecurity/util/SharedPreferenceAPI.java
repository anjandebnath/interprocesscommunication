...
public class SharedPreferenceAPI extends ContentProvider {
    ...
    public static final String PREFERENCE_NAME = "my_pref";
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (matcher.match(uri)) {
            case MATCH_DATA:
                ...
                SharedPreferences sharedPreferences = getContext().getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
